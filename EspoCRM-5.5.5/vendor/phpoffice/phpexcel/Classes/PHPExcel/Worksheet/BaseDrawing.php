 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Worksheet\BaseDrawing implements \PhpOffice\PhpSpreadsheet\IComparable
{
	/**
	 * Image counter
	 *
    ...
    /**
     * Create a new \PhpOffice\PhpSpreadsheet\Worksheet\BaseDrawing
     */
    ...
    public function setWorksheet(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $pValue = null, $pOverrideOld = false) {
    	if (is_null($this->_worksheet)) {
    		...
    		if ($pOverrideOld) {
    			...
    			throw new \PhpOffice\PhpSpreadsheet\Exception("A \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet has already been assigned. Drawings can only exist on one \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet.");
    		}
    	}
    	return $this;
    }
