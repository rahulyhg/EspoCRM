...
class AutoFilterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_mockWorksheetObject = $this->getMockBuilder('\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet')
        	->disableOriginalConstructor()
        	->getMock();
        $this->_mockCacheController = $this->getMockBuilder('\PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_Memory')
        	->disableOriginalConstructor()
        	->getMock();
		...
		$this->_testAutoFilterObject = new \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter(
	...
	public function testGetParent()
	{
		...
		$this->assertInstanceOf('\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet', $result);
	}
	...
	public function testSetColumnWithString()
	{
		...
		$this->assertInstanceOf('\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column', $result[$expectedResult]);
	}
	...
	{
		$expectedResult = 'M';
		$columnObject = new \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column($expectedResult);
	...
	{
		$invalidColumn = 'E';
		$columnObject = new \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column($invalidColumn);
	...
	public function testGetColumns()
	{
		...
		foreach($columnIndexes as $columnIndex) {
			...
			$this->assertInstanceOf('\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column', $result[$columnIndex]);
		}
	}
