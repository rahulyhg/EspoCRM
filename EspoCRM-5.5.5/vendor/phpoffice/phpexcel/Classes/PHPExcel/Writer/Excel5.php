 ...
 * @package    \PhpOffice\PhpSpreadsheet\Writer\Xls
 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Writer\Xls extends \PhpOffice\PhpSpreadsheet\Writer\BaseWriter implements \PhpOffice\PhpSpreadsheet\Writer\IWriter
{
	/**
	...
	/**
	 * Create a new \PhpOffice\PhpSpreadsheet\Writer\Xls
	 *
	...
	public function __construct(\PhpOffice\PhpSpreadsheet\Spreadsheet $phpExcel) {
		...
		$this->_parser		= new \PhpOffice\PhpSpreadsheet\Writer\Xls\Parser();
	}
	...
	public function save($pFilename = null) {
		...
		$this->_writerWorkbook = new \PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook($this->_phpExcel,
		...
		for ($i = 0; $i < $countSheets; ++$i) {
			$this->_writerWorksheets[$i] = new \PhpOffice\PhpSpreadsheet\Writer\Xls\Worksheet($this->_str_total, $this->_str_unique,
	...
	private function _buildWorkbookEscher()
	{
		...
		foreach ($this->_phpExcel->getAllsheets() as $sheet) {
			foreach ($sheet->getDrawingCollection() as $drawing) {
				...
				} else if ($drawing instanceof \PhpOffice\PhpSpreadsheet\Worksheet\MemoryDrawing) {
