 ...
 * @copyright        Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Reader\Xls\MD5
{
    // Context
    private $a;
    private $b;
    ...
    public function add($data)
    {
        ...
        $F = array('\PhpOffice\PhpSpreadsheet\Reader\Xls\MD5','F');
        $G = array('\PhpOffice\PhpSpreadsheet\Reader\Xls\MD5','G');
        $H = array('\PhpOffice\PhpSpreadsheet\Reader\Xls\MD5','H');
        $I = array('\PhpOffice\PhpSpreadsheet\Reader\Xls\MD5','I');
