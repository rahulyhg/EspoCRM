...
class ColorTest extends PHPUnit_Framework_TestCase
{
	...
	public function testGetRed()
	{
		...
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Style\Color','getRed'),$args);
	...
	public function testGetGreen()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Style\Color','getGreen'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testGetBlue()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Style\Color','getBlue'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testChangeBrightness()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Style\Color','changeBrightness'),$args);
		$this->assertEquals($expectedResult, $result);
	}
