...
class TextDataTest extends PHPUnit_Framework_TestCase
{
	...
	public function testCHAR()
	{
		...
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','CHARACTER'),$args);
	...
	public function testCODE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','ASCIICODE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testCONCATENATE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','CONCATENATE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testLEFT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','LEFT'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testMID()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','MID'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testRIGHT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','RIGHT'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testLOWER()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','LOWERCASE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testUPPER()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','UPPERCASE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testPROPER()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','PROPERCASE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testLEN()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','STRINGLENGTH'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testSEARCH()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','SEARCHINSENSITIVE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testFIND()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','SEARCHSENSITIVE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testREPLACE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','REPLACE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testSUBSTITUTE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','SUBSTITUTE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testTRIM()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','TRIMSPACES'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testCLEAN()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','TRIMNONPRINTABLE'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testDOLLAR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','DOLLAR'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testFIXED()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','FIXEDFORMAT'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','RETURNSTRING'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testTEXT()
	{
		...
		call_user_func(array('\PhpOffice\PhpSpreadsheet\Shared\StringHelper','setDecimalSeparator'),'.');
		call_user_func(array('\PhpOffice\PhpSpreadsheet\Shared\StringHelper','setThousandsSeparator'),',');
		call_user_func(array('\PhpOffice\PhpSpreadsheet\Shared\StringHelper','setCurrencyCode'),'$');

		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','TEXTFORMAT'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testVALUE()
	{
		...
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\TextData','VALUE'),$args);
