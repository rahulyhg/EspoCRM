 ...
 * @copyright    Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Collection\CellsFactory
{
     ...
     *
     * @return \PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_ICache|NULL
     **/
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach(self::$_storageMethods as $storageMethod) {
            $cacheStorageClass = '\PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = '\PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_'.$method;
        ...
        if (self::$_cacheStorageMethod === NULL) {
            self::$_cacheStorageClass = '\PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_' . $method;
     ...
     * @return    \PhpOffice\PhpSpreadsheet\Spreadsheet_CachedObjectStorage_ICache
     **/
