 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Style\Style extends \PhpOffice\PhpSpreadsheet\Style\Supervisor implements \PhpOffice\PhpSpreadsheet\IComparable
{
    /**
     * Font
     *
    ...
    /**
     * Create a new \PhpOffice\PhpSpreadsheet\Style\Style
     *
    ...
    public function __construct($isSupervisor = false, $isConditional = false)
    {
        ...
        $this->_font              = new \PhpOffice\PhpSpreadsheet\Style\Font($isSupervisor, $isConditional);
        $this->_fill              = new \PhpOffice\PhpSpreadsheet\Style\Fill($isSupervisor, $isConditional);
        $this->_borders           = new \PhpOffice\PhpSpreadsheet\Style\Borders($isSupervisor, $isConditional);
        $this->_alignment         = new \PhpOffice\PhpSpreadsheet\Style\Alignment($isSupervisor, $isConditional);
        $this->_numberFormat      = new \PhpOffice\PhpSpreadsheet\Style\NumberFormat($isSupervisor, $isConditional);
        $this->_protection        = new \PhpOffice\PhpSpreadsheet\Style\Protection($isSupervisor, $isConditional);
     ...
     *
     * <code>
     * $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getStyle('B2')->applyFromArray(
     *         array(
     *             'font'    => array(
     *                 'name'      => 'Arial',
     *                 'bold'      => true,
