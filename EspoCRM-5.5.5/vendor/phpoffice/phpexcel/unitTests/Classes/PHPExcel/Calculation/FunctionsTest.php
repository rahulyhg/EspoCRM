...
class FunctionsTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$result = \PhpOffice\PhpSpreadsheet\Calculation\Functions::DUMMY();
		$this->assertEquals('#Not Yet Implemented', $result);
	}

	public function testDIV0()
	{
		$result = \PhpOffice\PhpSpreadsheet\Calculation\Functions::DIV0();
		$this->assertEquals('#DIV/0!', $result);
	}

	public function testNA()
	{
		$result = \PhpOffice\PhpSpreadsheet\Calculation\Functions::NA();
		$this->assertEquals('#N/A', $result);
	}

	public function testNaN()
	{
		$result = \PhpOffice\PhpSpreadsheet\Calculation\Functions::NaN();
		$this->assertEquals('#NUM!', $result);
	}

	public function testNAME()
	{
		$result = \PhpOffice\PhpSpreadsheet\Calculation\Functions::NAME();
		$this->assertEquals('#NAME?', $result);
	}

	public function testREF()
	{
		$result = \PhpOffice\PhpSpreadsheet\Calculation\Functions::REF();
		$this->assertEquals('#REF!', $result);
	}

	public function testNULL()
	{
		$result = \PhpOffice\PhpSpreadsheet\Calculation\Functions::NULL();
	...
	public function testIS_BLANK()
	{
		...
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_BLANK'),$args);
	...
	public function testIS_ERR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_ERR'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIS_ERROR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_ERROR'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testERROR_TYPE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','ERROR_TYPE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIS_LOGICAL()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_LOGICAL'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIS_NA()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_NA'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIS_NUMBER()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_NUMBER'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIS_TEXT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_TEXT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIS_NONTEXT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_NONTEXT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIS_EVEN()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_EVEN'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIS_ODD()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','IS_ODD'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testTYPE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','TYPE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testN()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Functions','N'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
