 ...
 * @copyright	Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Calculation\DateTime {
	 ...
	 * and time format of your regional settings. \PhpOffice\PhpSpreadsheet\Spreadsheet does not change cell formatting in this way.
	 *
	 * Excel Function:
	 *		NOW()
	 *
	 ...
	 *
	 * NOTE: When used in a Cell Formula, MS Excel changes the cell format so that it matches the date
	 * format of your regional settings. \PhpOffice\PhpSpreadsheet\Spreadsheet does not change cell formatting in this way.
	 *
	 * Excel Function:
	 *		DATE(year,month,day)
	 *
	 * \PhpOffice\PhpSpreadsheet\Spreadsheet is a lot more forgiving than MS Excel when passing non numeric values to this function.
	...
	public static function DATEVALUE($dateValue = 1) {
		$dateValue = trim(\PhpOffice\PhpSpreadsheet\Calculation\Functions::flattenSingleValue($dateValue),'"');
	...
	public static function TIMEVALUE($timeValue) {
		$timeValue = trim(\PhpOffice\PhpSpreadsheet\Calculation\Functions::flattenSingleValue($timeValue),'"');
