 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Writer\Xlsx\Chart extends
   ...
   */
  public function writeChart(\PhpOffice\PhpSpreadsheet\Chart\Chart $pChart = NULL) {
    // Create XML writer
    $objWriter = NULL;
   ...
   * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
   */
  private function _writeTitle(\PhpOffice\PhpSpreadsheet\Chart\Title $title = NULL, $objWriter) {
    if (is_null($title)) {
      return;
    }
   ...
   * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
   */
  private function _writeLegend(\PhpOffice\PhpSpreadsheet\Chart\Legend $legend = NULL, $objWriter) {
    if (is_null($legend)) {
      return;
    }
   ...
   * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
   */
  private function _writeCatAx($objWriter, \PhpOffice\PhpSpreadsheet\Chart\PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis) {
   ...
   * @throws  \PhpOffice\PhpSpreadsheet\Writer\Exception
   */
  private function _writeValAx($objWriter, \PhpOffice\PhpSpreadsheet\Chart\PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines) {
