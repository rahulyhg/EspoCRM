...
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A1', "Cell B3 and B5 contain data validation...")
...
$objValidation = $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B3')->getDataValidation();
...
$objValidation = $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B5')->getDataValidation();
...
$objValidation = $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B7')->getDataValidation();
$objValidation->setType( \PhpOffice\PhpSpreadsheet\Cell\DataValidation::TYPE_LIST );
$objValidation->setErrorStyle( \PhpOffice\PhpSpreadsheet\Cell\DataValidation::STYLE_INFORMATION );
$objValidation->setAllowBlank(false);
$objValidation->setShowInputMessage(true);
