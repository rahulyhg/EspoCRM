...
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A22', 'CountA:')
                              ->setCellValue('A23', 'MaxA:')
                              ->setCellValue('A24', 'MinA:');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A26', 'StDev:')
                              ->setCellValue('A27', 'StDevA:')
                              ->setCellValue('A28', 'StDevP:')
                              ->setCellValue('A29', 'StDevPA:');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A31', 'DevSq:')
                              ->setCellValue('A32', 'Var:')
                              ->setCellValue('A33', 'VarA:')
                              ->setCellValue('A34', 'VarP:')
                              ->setCellValue('A35', 'VarPA:');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A37', 'Date:');
...
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('B22', '=COUNTA(B2:B12)')
                              ->setCellValue('B23', '=MAXA(B2:B12)')
                              ->setCellValue('B24', '=MINA(B2:B12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('B26', '=STDEV(B2:B12)')
                              ->setCellValue('B27', '=STDEVA(B2:B12)')
                              ->setCellValue('B28', '=STDEVP(B2:B12)')
                              ->setCellValue('B29', '=STDEVPA(B2:B12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('B31', '=DEVSQ(B2:B12)')
                              ->setCellValue('B32', '=VAR(B2:B12)')
                              ->setCellValue('B33', '=VARA(B2:B12)')
                              ->setCellValue('B34', '=VARP(B2:B12)')
                              ->setCellValue('B35', '=VARPA(B2:B12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('B37', '=DATE(2007, 12, 21)')
...
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('C22', '=COUNTA(C2:C12)')
                              ->setCellValue('C23', '=MAXA(C2:C12)')
                              ->setCellValue('C24', '=MINA(C2:C12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('C26', '=STDEV(C2:C12)')
                              ->setCellValue('C27', '=STDEVA(C2:C12)')
                              ->setCellValue('C28', '=STDEVP(C2:C12)')
                              ->setCellValue('C29', '=STDEVPA(C2:C12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('C31', '=DEVSQ(C2:C12)')
...
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('D14', '=((D2 * D3) + D4) & " should be 10"');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('E12', 'Other functions')
                              ->setCellValue('E14', '=PI()')
                              ->setCellValue('E15', '=RAND()')
                              ->setCellValue('E16', '=RANDBETWEEN(5, 10)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('E17', 'Count of both ranges:')
                              ->setCellValue('F17', '=COUNT(B2:C12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('E18', 'Total of both ranges:')
                              ->setCellValue('F18', '=SUM(B2:C12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('E19', 'Maximum of both ranges:')
                              ->setCellValue('F19', '=MAX(B2:C12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('E20', 'Minimum of both ranges:')
                              ->setCellValue('F20', '=MIN(B2:C12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('E21', 'Average of both ranges:')
                              ->setCellValue('F21', '=AVERAGE(B2:C12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('E22', 'Median of both ranges:')
                              ->setCellValue('F22', '=MEDIAN(B2:C12)');

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('E23', 'Mode of both ranges:')
...
for ($col = 'B'; $col != 'G'; ++$col) {
    for($row = 14; $row <= 41; ++$row) {
        if ((!is_null($formula = $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell($col.$row)->getValue())) &&
			($formula[0] == '=')) {
            echo 'Value of ' , $col , $row , ' [' , $formula , ']: ' ,
                               $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell($col.$row)->getCalculatedValue() . EOL;
        }
    }
}
...
//
//  If we set Pre Calculated Formulas to true then \PhpOffice\PhpSpreadsheet\Spreadsheet will calculate all formulae in the
