...
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A5', 'Sum:');
...
echo date('H:i:s') , " Sum of Range #1 is " ,
                     $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B5')->getCalculatedValue() , EOL;
...
echo date('H:i:s') , " Sum of Range #2 is " ,
                     $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('C5')->getCalculatedValue() , EOL;

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A7', 'Total of both ranges:');
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('B7', '=SUM(B5:C5)');
echo date('H:i:s') , " Sum of both Ranges is " ,
                     $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B7')->getCalculatedValue() , EOL;

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A8', 'Minimum of both ranges:');
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('B8', '=MIN(B2:C4)');
echo date('H:i:s') , " Minimum value in either Range is " ,
                     $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B8')->getCalculatedValue() , EOL;

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A9', 'Maximum of both ranges:');
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('B9', '=MAX(B2:C4)');
echo date('H:i:s') , " Maximum value in either Range is " ,
                     $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B9')->getCalculatedValue() , EOL;

$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('A10', 'Average of both ranges:');
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setCellValue('B10', '=AVERAGE(B2:C4)');
echo date('H:i:s') , " Average value of both Ranges is " ,
                     $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B10')->getCalculatedValue() , EOL;


// Rename worksheet
echo date('H:i:s') , " Rename worksheet" , EOL;
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setTitle('Formulas');
