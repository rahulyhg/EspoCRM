...
class AutofilterColumnTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_mockAutoFilterObject = $this->getMockBuilder('\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter')
		...
		$this->_testAutoFilterColumnObject = new \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column(
	...
	public function testGetParent()
	{
		...
		$this->assertInstanceOf('\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter', $result);
	}
	...
	public function testGetFilterType()
	{
		...
		$this->assertEquals(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_FILTER, $result);
	}

	public function testSetFilterType()
	{
		$result = $this->_testAutoFilterColumnObject->setFilterType(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_DYNAMICFILTER);
		$this->assertInstanceOf('\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column', $result);

		$result = $this->_testAutoFilterColumnObject->getFilterType();
		$this->assertEquals(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_DYNAMICFILTER, $result);
	}
	...
	public function testGetJoin()
	{
		...
		$this->assertEquals(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_OR, $result);
	}

	public function testSetJoin()
	{
		$result = $this->_testAutoFilterColumnObject->setJoin(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_AND);
		$this->assertInstanceOf('\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column', $result);

		$result = $this->_testAutoFilterColumnObject->getJoin();
		$this->assertEquals(\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_AND, $result);
	}
