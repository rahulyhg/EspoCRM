 ...
 * @package	\PhpOffice\PhpSpreadsheet\Spreadsheet_Shared
 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Shared\Date
{
	/** constants */
	 ...
	 */
	public static function excelToTimestamp($dateValue = 0, $adjustToTimezone = FALSE, $timezone = NULL) {
	 ...
	 */
	public static function excelToDateTimeObject($dateValue = 0) {
		...
		return $dateObj;
	}	//	function excelToDateTimeObject()
