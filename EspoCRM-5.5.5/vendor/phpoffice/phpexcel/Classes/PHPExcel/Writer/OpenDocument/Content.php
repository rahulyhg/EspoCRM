 ...
 */
class \PhpOffice\PhpSpreadsheet\Writer\Ods\Content extends \PhpOffice\PhpSpreadsheet\Writer\Ods\WriterPart
{
    ...
    public function write(\PhpOffice\PhpSpreadsheet\Spreadsheet $p\PhpOffice\PhpSpreadsheet\Spreadsheet = null)
    {
        if (!$p\PhpOffice\PhpSpreadsheet\Spreadsheet) {
            $p\PhpOffice\PhpSpreadsheet\Spreadsheet = $this->getParentWriter()->get\PhpOffice\PhpSpreadsheet\Spreadsheet(); /* @var $p\PhpOffice\PhpSpreadsheet\Spreadsheet \PhpOffice\PhpSpreadsheet\Spreadsheet */
        }
    ...
    private function _writeSheets(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter)
    {
        ...
        $sheet_count = $p\PhpOffice\PhpSpreadsheet\Spreadsheet->getSheetCount();
        for ($i = 0; $i < $sheet_count; $i++) {
            //$this->getWriterPart('Worksheet')->writeWorksheet());
            $objWriter->startElement('table:table');
                $objWriter->writeAttribute('table:name', $p\PhpOffice\PhpSpreadsheet\Spreadsheet->getSheet($i)->getTitle());
                $objWriter->writeElement('office:forms');
                $objWriter->startElement('table:table-column');
                    $objWriter->writeAttribute('table:number-columns-repeated', self::NUMBER_COLS_REPEATED_MAX);
                $objWriter->endElement();
                $this->_writeRows($objWriter, $p\PhpOffice\PhpSpreadsheet\Spreadsheet->getSheet($i));
            $objWriter->endElement();
        }
    }
     ...
     */
    private function _writeRows(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter, \PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $sheet)
    {
     ...
     * @throws \PhpOffice\PhpSpreadsheet\Writer\Exception
     */
    private function _writeCells(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter, \PhpOffice\PhpSpreadsheet\Worksheet\Row $row)
    {
     ...
     */
    private function _writeCellSpan(\PhpOffice\PhpSpreadsheet\Shared\XMLWriter $objWriter, $curColumn, $prevColumn)
    {
