 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter
{
	/**
	 ...
	 *
	 * @var array of \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column
	 */
	private $_columns = array();


    /**
     * Create a new \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter
	 *
	 ...
	 *
	 * @throws	\PhpOffice\PhpSpreadsheet\Exception
	 * @return array of \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column
	 */
				...
				case \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_DYNAMICFILTER :
					...
					foreach($rules as $rule) {
						...
						if (($dynamicRuleType == \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule::AUTOFILTER_RULETYPE_DYNAMIC_ABOVEAVERAGE) ||
							...
							$average = \PhpOffice\PhpSpreadsheet\Calculation\Calculation::getInstance()->calculateFormula($averageFormula,NULL,$this->_workSheet->getCell('A1'));
...
//				echo 'Value is ',$cellValue,PHP_EOL;
				...
				$result = $result &&
					call_user_func_array(
						array('\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter',$columnFilterTest['method']),
						array(
							$cellValue,
