...
class MathTrigTest extends PHPUnit_Framework_TestCase
{
	...
	public function testATAN2()
	{
		...
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','ATAN2'),$args);
	...
	public function testCEILING()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','CEILING'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testCOMBIN()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','COMBIN'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testEVEN()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','EVEN'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testODD()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','ODD'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testFACT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','FACT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testFACTDOUBLE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','FACTDOUBLE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testFLOOR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','FLOOR'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testGCD()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','GCD'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testLCM()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','LCM'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testINT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','INT'),$args);
	...
	public function testSIGN()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','SIGN'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testPOWER()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','POWER'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testLOG()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','LOG_BASE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testMOD()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','MOD'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testMDETERM()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','MDETERM'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testMINVERSE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','MINVERSE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testMMULT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','MMULT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testMULTINOMIAL()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','MULTINOMIAL'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testMROUND()
	{
		...
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','MROUND'),$args);
		\PhpOffice\PhpSpreadsheet\Calculation\Calculation::setArrayReturnType(\PhpOffice\PhpSpreadsheet\Calculation\Calculation::RETURN_ARRAY_AS_ARRAY);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testPRODUCT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','PRODUCT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testQUOTIENT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','QUOTIENT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testROUNDUP()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','ROUNDUP'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testROUNDDOWN()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','ROUNDDOWN'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testSERIESSUM()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','SERIESSUM'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testSUMSQ()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','SUMSQ'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testTRUNC()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','TRUNC'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
	...
	public function testROMAN()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','ROMAN'),$args);
		$this->assertEquals($expectedResult, $result);
	}
	...
	public function testSQRTPI()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig','SQRTPI'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-12);
	}
    ...
    public function testSUMIF()
    {
        $args = func_get_args();
        $expectedResult = array_pop($args);
        $result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\MathTrig', 'SUMIF'), $args);
        $this->assertEquals($expectedResult, $result, NULL, 1E-12);
    }
