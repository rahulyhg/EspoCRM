 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Style\NumberFormat extends \PhpOffice\PhpSpreadsheet\Style\Supervisor implements \PhpOffice\PhpSpreadsheet\IComparable
{
	/* Pre-defined formats */
	...
	/**
	 * Create a new \PhpOffice\PhpSpreadsheet\Style\NumberFormat
	 *
	 ...
	 *
	 * <code>
	 * $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getStyle('B2')->getNumberFormat()->applyFromArray(
	 *		array(
	 ...
	 */
	public static function toFormattedString($value = '0', $format = \PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_GENERAL, $callBack = null)
	{
