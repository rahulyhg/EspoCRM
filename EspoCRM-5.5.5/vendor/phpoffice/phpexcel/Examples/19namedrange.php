...
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->addNamedRange( new \PhpOffice\PhpSpreadsheet\NamedRange('PersonName', $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet(), 'B1') );
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->addNamedRange( new \PhpOffice\PhpSpreadsheet\NamedRange('PersonLN', $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet(), 'B2') );

// Rename named ranges
echo date('H:i:s') , " Rename named ranges" , EOL;
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getNamedRange('PersonName')->setName('PersonFN');

// Rename worksheet
echo date('H:i:s') , " Rename worksheet" , EOL;
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setTitle('Person');
...
echo 'Cell B1 {=PersonFN}: ' , $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B1')->getCalculatedValue() , EOL;
echo 'Cell B3 {=PersonFN & " " & PersonLN}: ' , $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('B3')->getCalculatedValue() , EOL;
echo 'Cell Person!B1: ' , $obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->getCell('Person!B1')->getCalculatedValue() , EOL;

// Rename worksheet
echo date('H:i:s') , " Rename worksheet" , EOL;
$obj\PhpOffice\PhpSpreadsheet\Spreadsheet->getActiveSheet()->setTitle('Person (cloned)');
