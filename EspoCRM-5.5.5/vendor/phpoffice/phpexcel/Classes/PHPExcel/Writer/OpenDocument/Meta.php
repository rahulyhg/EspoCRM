 ...
 */
class \PhpOffice\PhpSpreadsheet\Writer\Ods\Meta extends \PhpOffice\PhpSpreadsheet\Writer\Ods\WriterPart
{
    /**
    ...
    public function write(\PhpOffice\PhpSpreadsheet\Spreadsheet $p\PhpOffice\PhpSpreadsheet\Spreadsheet = null)
    {
        ...
        $objWriter->startElement('office:document-meta');
            ...
            $objWriter->startElement('office:meta');
                $objWriter->writeElement('meta:initial-creator', $p\PhpOffice\PhpSpreadsheet\Spreadsheet->getProperties()->getCreator());
                $objWriter->writeElement('dc:creator', $p\PhpOffice\PhpSpreadsheet\Spreadsheet->getProperties()->getCreator());
                $objWriter->writeElement('meta:creation-date', date(DATE_W3C, $p\PhpOffice\PhpSpreadsheet\Spreadsheet->getProperties()->getCreated()));
                $objWriter->writeElement('dc:date', date(DATE_W3C, $p\PhpOffice\PhpSpreadsheet\Spreadsheet->getProperties()->getCreated()));
                ...
                $keywords = explode(' ', $p\PhpOffice\PhpSpreadsheet\Spreadsheet->getProperties()->getKeywords());
                ...
                $objWriter->startElement('meta:user-defined');
                    ...
                    $objWriter->writeRaw($p\PhpOffice\PhpSpreadsheet\Spreadsheet->getProperties()->getCompany());
                $objWriter->endElement();
                $objWriter->startElement('meta:user-defined');
                    $objWriter->writeAttribute('meta:name', 'category');
                    $objWriter->writeRaw($p\PhpOffice\PhpSpreadsheet\Spreadsheet->getProperties()->getCategory());
                $objWriter->endElement();
            $objWriter->endElement();
        $objWriter->endElement();
