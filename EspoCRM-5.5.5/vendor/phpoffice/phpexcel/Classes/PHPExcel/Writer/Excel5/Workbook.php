 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook extends \PhpOffice\PhpSpreadsheet\Writer\Xls\BIFFwriter
{
	/**
	 * Formula parser
	 *
	 ...
	 */
	public function __construct(\PhpOffice\PhpSpreadsheet\Spreadsheet $phpExcel = null,
	...
	private function _writeWindow1()
	{
		...
		// not supported by \PhpOffice\PhpSpreadsheet\Spreadsheet, so there is only one selected sheet, the active
		$ctabsel   = 1;       // Number of workbook tabs selected

		$wTabRatio = 0x0258;                 // Tab to scrollbar ratio

		// not supported by \PhpOffice\PhpSpreadsheet\Spreadsheet, set to 0
