...
class FinancialTest extends PHPUnit_Framework_TestCase
{
	...
	public function testACCRINT()
	{
		...
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','ACCRINT'),$args);
	...
	public function testACCRINTM()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','ACCRINTM'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testAMORDEGRC()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','AMORDEGRC'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testAMORLINC()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','AMORLINC'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testCOUPDAYBS()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','COUPDAYBS'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testCOUPDAYS()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','COUPDAYS'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testCOUPDAYSNC()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','COUPDAYSNC'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testCOUPNCD()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','COUPNCD'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testCOUPNUM()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','COUPNUM'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testCOUPPCD()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','COUPPCD'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testCUMIPMT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','CUMIPMT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testCUMPRINC()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','CUMPRINC'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testDB()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','DB'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testDDB()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','DDB'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testDISC()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','DISC'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testDOLLARDE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','DOLLARDE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testDOLLARFR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','DOLLARFR'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testEFFECT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','EFFECT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testFV()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','FV'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testFVSCHEDULE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','FVSCHEDULE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testINTRATE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','INTRATE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIPMT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','IPMT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testIRR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','IRR'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testISPMT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','ISPMT'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testMIRR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','MIRR'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testNOMINAL()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','NOMINAL'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testNPER()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','NPER'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testNPV()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','NPV'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testPRICE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','PRICE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testRATE()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','RATE'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
	...
	public function testXIRR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Financial','XIRR'),$args);
		$this->assertEquals($expectedResult, $result, NULL, 1E-8);
	}
