...
class LogicalTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$result = \PhpOffice\PhpSpreadsheet\Calculation\Logical::TRUE();
		$this->assertEquals(TRUE, $result);
	}

	public function testFALSE()
	{
		$result = \PhpOffice\PhpSpreadsheet\Calculation\Logical::FALSE();
	...
	public function testAND()
	{
		...
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Logical','LOGICAL_AND'),$args);
	...
	public function testOR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Logical','LOGICAL_OR'),$args);
		$this->assertEquals($expectedResult, $result);
	}
    ...
    public function testNOT()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Logical','NOT'),$args);
		$this->assertEquals($expectedResult, $result);
	}
    ...
    public function testIF()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Logical','STATEMENT_IF'),$args);
		$this->assertEquals($expectedResult, $result);
	}
    ...
    public function testIFERROR()
	{
		$args = func_get_args();
		$expectedResult = array_pop($args);
		$result = call_user_func_array(array('\PhpOffice\PhpSpreadsheet\Calculation\Logical','IFERROR'),$args);
		$this->assertEquals($expectedResult, $result);
	}
