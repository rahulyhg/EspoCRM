 ...
 * @copyright  Copyright (c) 2006 - 2014 \PhpOffice\PhpSpreadsheet\Spreadsheet (http://www.codeplex.com/\PhpOffice\PhpSpreadsheet\Spreadsheet)
 */
class \PhpOffice\PhpSpreadsheet\Writer\Xls\Worksheet extends \PhpOffice\PhpSpreadsheet\Writer\Xls\BIFFwriter
{
	/**
	 * Formula parser
	 *
...
//			if ($row + 1 > 65536 or $column + 1 > 256) {
	...
	private function _writeWindow2()
	{
		...
		// no support in \PhpOffice\PhpSpreadsheet\Spreadsheet for selected sheet, therefore sheet is only selected if it is the active sheet
